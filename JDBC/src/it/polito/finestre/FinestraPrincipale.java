...
public class FinestraPrincipale extends JFrame {
	...
	public FinestraPrincipale(final DB db) {
		...
		setSize(250, 150);
		// setto la posizione in cui verra' mostrata
		setLocation(dim.width / 2 - getWidth() / 2, dim.height / 2 - getHeight() / 2);
		// disabilito la possibilita' di resize
		setResizable(false);
		// setto l'uscita automatica dal programma quando l'icona X viene
		// premuta
		setDefaultCloseOperation(EXIT_ON_CLOSE);

		/*
		 * Creo un pannello che verra' inserito a north del frame e che
		 * conterra' i miei elementi.
		 * 
		 * Utilizzo il GridBagLayout per comodita' nel posizionare i vari
		 * elementi.
		 * 
		 */
		...
		/*
		 * Creo un pannello che verra' inserito centralmente al frame e che
		 * conterra' i miei elementi.
		 * 
		 * Utilizzo il GridBagLayout per comodita' nel posizionare i vari
		 * elementi.
		...
		/*
		 * Listen anonimo sul Bottone Info Cliente. Apre una nuova finestra
		 * relativa alle Info del Cliente
		 * 
		 */
		...
		/*
		 * Listen anonimo sul Bottone Iscrizione Corsi. Apre una nuova finestra
		 * relativa alla Iscrizione ai Corsi
		 * 
		 */
		...
		/*
		 * Listen anonimo sul finestra principale. Serve per intercettare quando
		 * l'utente preme l'icona X, quella di chiusura della finestra. In
		 * questo modo possiamo essere sicuri che la connessione al Db venga
		 * chiusa giusto prima che venga fatto il dispose() del nostro
		 * programma.
		 * 
		 */
