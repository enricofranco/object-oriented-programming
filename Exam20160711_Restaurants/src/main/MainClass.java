...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Non hanno ordinato: " + r1.getUnordered()); // [Anna,
																			// Chiara]
		...
		/*
		 * Ristoranti ordinati per incassi decrescenti: Mac2 - incasso: 178.0
		 * Mac1 - incasso: 102.5 Mac3 - incasso: 0.0
		 */
		...
		/*
		 * Ristoranti ordinati per clienti-non-accolti crescenti: Mac2 -
		 * clienti-non-accolti: 0 Mac1 - clienti-non-accolti: 5 Mac3 -
		 * clienti-non-accolti: 9
		 */
		...
		/*
		 * Ristoranti ordinati per tavoli-non-usati crescenti: Mac1 -
		 * tavoli-non-usati: 1 Mac3 - tavoli-non-usati: 2 Mac2 -
		 * tavoli-non-usati: 5
		 */
	}
}
